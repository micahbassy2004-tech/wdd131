...
const temples = [
  ...
  { templeName: "Accra Ghana", location: "Accra, Ghana", dedicated: "2004, January, 11", area: 17500, imageUrl: "https://content.churchofjesuschrist.org/.../accra.jpg" },
  { templeName: "Rome Italy", location: "Rome, Italy", dedicated: "2019, March, 10", area: 41000, imageUrl: "https://content.churchofjesuschrist.org/.../rome.jpg" },
  { templeName: "Paris France", location: "Paris, France", dedicated: "2017, May, 21", area: 44175, imageUrl: "https://content.churchofjesuschrist.org/.../paris.jpg" }
];
...
["home","old","new","large","small"].forEach(id => {
  document.getElementById(id).addEventListener("click", e => {
    e.preventDefault();
    switch(id) {
      case "home": displayTemples(temples); break;
      case "old": displayTemples(temples.filter(t => parseInt(t.dedicated) < 1900)); break;
      case "new": displayTemples(temples.filter(t => parseInt(t.dedicated) > 2000)); break;
      case "large": displayTemples(temples.filter(t => t.area > 90000)); break;
      case "small": displayTemples(temples.filter(t => t.area < 10000)); break;
    }
  });
});
